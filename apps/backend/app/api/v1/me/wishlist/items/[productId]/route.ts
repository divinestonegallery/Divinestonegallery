import { requiredString } from "@/modules/catalog/input";
import { collectionUnavailable, requireCustomer } from "@/modules/collections/http";
import { readCustomerCollections, removeWishlistProduct } from "@/modules/collections/repository";
...
export async function DELETE(
  ...
  try {
    await removeWishlistProduct(authorization.clerkUserId, productId);
