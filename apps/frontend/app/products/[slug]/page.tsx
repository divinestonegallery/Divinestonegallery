...
import { getProductDetail, getPublicCatalogItem } from "@/server/backend-api-client";
import { ProductActions } from "@/features/catalog/product-actions";
import { ProductGallery } from "@/features/catalog/product-gallery";
import styles from "@/features/catalog/product-detail.module.css";
...
export default async function ProductPage({ params }: ProductPageProps) {
  ...
  if (!detail) notFound();
  const { product, related, gallery } = detail;
