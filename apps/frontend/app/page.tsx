...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title: { absolute: page?.seoTitle ?? "Divine Stone Gallery | Hand-Carved Marble Moorties" },
    description: page?.seoDescription ?? "Discover authentic hand-carved marble moorties by fourth-generation master moortikars from Alwar, Rajasthan.",
