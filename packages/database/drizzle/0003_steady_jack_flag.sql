...
('section:home:hero', 'page:home', 'hero', 'hero', 'From Alwar, Rajasthan · Since 1960', 'Sacred forms, carved for generations.', 'Authentic hand-carved marble moorties shaped by fourth-generation master moortikars and guided by the principles of Shilp Shastra.', 'Explore moorties', '/shop', 'Customize Your Moorti', '/custom-murti', 'right', '[]', 'warm', 0, true),
