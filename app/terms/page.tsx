...
export default function TermsPage() {
  ...
  return (
    <LegalPage title="Website terms" eyebrow="Using this gallery" intro="The conditions for accounts, ready-made orders, individual quotations and custom commissions placed with Divine Stone Gallery.">
      ...
      <section className={styles.contactBox}><h2 className="font-display">Questions or complaints</h2><p>{business.legalName ? `${business.legalName}. ` : ""}{business.address ? `${business.address}. ` : ""}Email <a href={`mailto:${business.grievanceEmail || "divinestonegallery@gmail.com"}`}>{business.grievanceEmail || "divinestonegallery@gmail.com"}</a>, call {business.grievancePhone || "+91 63768 71065"} or <Link href="/contact">contact the gallery</Link>. {business.grievanceOfficerName ? `Grievance officer: ${business.grievanceOfficerName}. ` : ""}Keep your order or commission reference available so the correct record can be reviewed.</p></section>
    </LegalPage>
  );
}
